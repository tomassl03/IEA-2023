...
# Inicializa o objeto HX711 com os pinos especificados (DT = 16, SCK = 4)
ss = HX711(16,4)   # GIOP16 - DT - GIOP4 - SCK

from datetime import datetime

while True:
    # Solicitar entrada do usuário para continuar ou parar
    continuar = input("Deseja continuar? (S/N): ")
    
    # Verificar se o utilizador deseja parar
